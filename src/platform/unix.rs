...
pub trait WindowExtUnix {
  ...
  /// Returns the `gtk::Fixed` content container added inside the default vbox.
  /// Returns `None` if the default vbox creation was disabled by [`WindowBuilderExtUnix::with_default_vbox`].
